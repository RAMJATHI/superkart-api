...
Product_Weight = st.number_input("Product Weight", min_value=0.0, value=15.34)
Product_Sugar_Content = st.selectbox("Product Sugar Content", ["Low Sugar", "Regular", "No Sugar"])
Product_Allocated_Area = st.number_input("Product Allocated Area", min_value=0.0, value=0.032)
Product_MRP = st.number_input("Product MRP", min_value=0.0, value=118.02)
